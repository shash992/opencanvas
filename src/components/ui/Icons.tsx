...
export function InfinityIcon({ className = '' }: { className?: string }) {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M18.178 8.103c-1.783-1.783-4.68-1.783-6.463 0L8.178 9.603c-1.783 1.783-4.68 1.783-6.463 0" />
      <path d="M5.822 15.897c1.783 1.783 4.68 1.783 6.463 0l3.537-1.5c1.783-1.783 4.68-1.783 6.463 0" />
    </svg>
  )
}
